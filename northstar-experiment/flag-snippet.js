...
async function checkNorthStarFlag(userEmail, userId) {
  try {
    const res = await fetch(
      'https://www.agent-northstar.com/api/flags/northstar-exp-high-volume-dtc-brands-achieve-increased-f5015z?email=' + encodeURIComponent(userEmail) + '&user_id=' + encodeURIComponent(userId || '')
    );
